...
-- Väljastage tabeli Person andmed ja kustutage 8. rida.
select * from Person
go
...
---Protseduur, mis annab välja ID-de koguarvu.
...
---Protseduur, kus me sisestame ID ja saame selle nime.
